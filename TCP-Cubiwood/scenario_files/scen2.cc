...
//	cmd.AddValue("interPacketInterval", "Inter-packet interval [us])", interPacketInterval);
  ...
  if(folder_dest == 1)
   {
      path_to_res = "results/Scenario2/Cubiwood_with_dcr/";     
   }

  else if(folder_dest == 2)
   {
      path_to_res = "results/Scenario2/Cubic/";     
   }
 
   else if(folder_dest == 3)
   {
      path_to_res = "results/Scenario2/Cubic_with_dcr/";     
   }

   else if(folder_dest == 4)
   {
      path_to_res = "results/testing/";     
   }
  ...
  if (cong_var == 1)
    ...
    else if (cong_var == 2)
      {
        ...
        Config::SetDefault ("ns3::TcpCubiwood::Alpha", DoubleValue (0.95));  
