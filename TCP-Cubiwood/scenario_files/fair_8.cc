...
//	cmd.AddValue("interPacketInterval", "Inter-packet interval [us])", interPacketInterval);
  ...
  if(dcr)
  {
    path_to_res = "results/Scenario3/Cubiwood_dcr/eight/";   
  }
  
  else
  {
    path_to_res = "results/Scenario3/Cubiwood/eight/";   
  } 
...
//Calle function e CalculateThroughput varaye mohasebe e throughput.
     ...
     //Simulator::Schedule (Seconds (0), &errorrate);
      ...
      TypeId tid5 = TypeId::LookupByName("ns3::TcpCubiwood");
      ...
      TypeId tid6 = TypeId::LookupByName("ns3::TcpCubiwood");
      ...
      TypeId tid7 = TypeId::LookupByName("ns3::TcpCubiwood");
      ...
      TypeId tid8 = TypeId::LookupByName("ns3::TcpCubiwood");
...
//
 ...
 AsciiTraceHelper ascii;
  ...
  xSum=thr+thr2+thr3+thr4+thr5+thr6+thr7+thr8;
  avg=xSum/8;
  x2Sum=thr*thr+thr2*thr2+thr3*thr3+thr4*thr4+thr5*thr5+thr6*thr6+thr7*thr7+thr8*thr8;
  fairnessIndex=(xSum*xSum)/(x2Sum*8);
