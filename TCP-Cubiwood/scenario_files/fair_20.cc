...
//	cmd.AddValue("interPacketInterval", "Inter-packet interval [us])", interPacketInterval);
  ...
  if(dcr)
  {
    path_to_res = "results/Scenario3/Cubiwood_dcr/twenty/";   
  }
  
  else
  {
    path_to_res = "results/Scenario3/Cubiwood/twenty/";   
  } 
...
//Calle function e CalculateThroughput varaye mohasebe e throughput.
     ...
     //Simulator::Schedule (Seconds (0), &errorrate);
      ...
      TypeId tid17 = TypeId::LookupByName("ns3::TcpCubiwood");
      ...
      TypeId tid18 = TypeId::LookupByName("ns3::TcpCubiwood");
      ...
      TypeId tid19 = TypeId::LookupByName("ns3::TcpCubiwood");
      ...
      TypeId tid20 = TypeId::LookupByName("ns3::TcpCubiwood");
